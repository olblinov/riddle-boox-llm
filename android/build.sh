...
"$TOOLS/aapt2" link -o "$BUILD/base.apk" -I "$SDK/platforms/android-35/android.jar" --manifest "$MANIFEST" --min-sdk-version 28 --target-sdk-version 30 --version-code 4 --version-name 0.4.0
