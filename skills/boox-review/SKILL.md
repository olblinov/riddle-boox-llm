...
2. Prepare readable pages with space between lines for notes. Use large high-contrast text, short sections, and simple diagrams. The Note Air2 Plus has 1404 × 1872 pixels at 227 ppi. Render at native width; avoid A4 framing, wide outer margins, or shrinking a document to fit one page. Keep source diagram data in the task for later edits.
